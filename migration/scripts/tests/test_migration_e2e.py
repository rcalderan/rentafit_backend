...
class TestMigrationE2E:
    ...
    def test_customers_has_default_plus_cliente(self, migration_result):
        ...
        # default + cliente + funcionario (employee tambem vira customer:
        # getNextLegacyId usa MAX(customers.legacy_id))
        assert len(rows) == 3
